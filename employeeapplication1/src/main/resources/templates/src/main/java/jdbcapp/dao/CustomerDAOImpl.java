...
public  class CustomerDAOImpl implements CustomerDAO {
	...
	public Customer getCustomerById(Integer customerId) {
		...
		try {
		PreparedStatement pStmt = DBConnectionUtil.getDBConnection().prepareStatement("select * from customer where customerId=?");
	...
	public List<Customer> getAllCustomers() {
		...
		try {
			...
			// Create a Statement
			Statement statement = DBConnectionUtil.getDBConnection().createStatement();
